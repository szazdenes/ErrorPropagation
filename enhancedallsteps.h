...
private:
    ...
    void writeDatFile(int usedpixels, QString imname, QString hyperbola, QString timeOfDay, int stein, int p1_res, double p2_res, double deltoid_res, double second_error_res, double elev_res, double azimuth_res, QVector<int> &histogram, double north);
